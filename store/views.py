...
def _localize_toolkit_image_url(toolkit):
    if not toolkit or not toolkit.image_url:
        return toolkit
    ...
    if 'supabase.co/storage/v1/object/public/' in image_url:
        ...
        if filename:
            toolkit.image_url = f'/static/img/{filename}'
...
def chattoolkit(request):
    ...
    toolkit = _localize_toolkit_image_url(toolkit)
